...
{
    public partial class PRConversationDataTemplateSelector : DataTemplateSelector
    {
        public DataTemplate? ReviewTemplate { get; set; }
        public DataTemplate? PlainCommentTemplate { get; set; }
        public DataTemplate? CommitNodeTemplate { get; set; }

        // issue event templates
        ...
        public DataTemplate? DefaultIssueEventTemplate { get; set; }

        protected override DataTemplate? SelectTemplateCore(object item)
        {
            if (item is ReviewNode)
            {
                return ReviewTemplate;
            }
            if (item is CommitNode)
            {
                return CommitNodeTemplate;
            }
            ...
            {
                return PlainCommentTemplate;
            }
        }

        private DataTemplate? GetIssueEventTemplate(EventNode node)
        {
            switch (node.State)
            {
                ...
                default:
                    return DefaultIssueEventTemplate;
            }
        }
    }
}
