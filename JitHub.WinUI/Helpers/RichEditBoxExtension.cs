...
namespace JitHub.WinUI.Helpers
{
    public class RichEditBoxExtension
    {
        ...
        public static readonly DependencyProperty PlainTextProperty =
          ...
          typeof(RichEditBoxExtension), new PropertyMetadata(string.Empty, OnPlainTextChanged));

        // Standard DP infrastructure
        public static string GetPlainText(DependencyObject o)
        {
            return o.GetValue(PlainTextProperty) as string ?? string.Empty;
        }

        // Standard DP infrastructure
        public static void SetPlainText(DependencyObject o, string? s)
        {
            o.SetValue(PlainTextProperty, s ?? string.Empty);
        }

        private static void OnPlainTextChanged(DependencyObject o,
          DependencyPropertyChangedEventArgs e)
        {
            if (o is not RichEditBox source || e.NewValue is null)
                return;
        ...
        static readonly DependencyProperty RichEditChangeStateHelperProperty =
          ...
          typeof(object), typeof(RichEditBoxExtension), null);
        ...
        static void AttachRichEditBoxChangingHelper(DependencyObject o)
        {
            ...
            if (o is not RichEditBox richEdit)
            {
                return;
            }
        ...
        {
            if (o.GetValue(RichEditChangeStateHelperProperty) is RichEditChangeStateHelper helper)
            {
                helper.State = state;
            }
        }
        ...
        {
            return o.GetValue(RichEditChangeStateHelperProperty) is RichEditChangeStateHelper helper
                ? helper.State
                : RichEditChangeState.Unknown;
        }
        #endregion
    }
}
