...
{
    public partial class HexColorToForegroundConverter : IValueConverter
    {
		public object Convert(object value, Type targetType, object parameter, string language)
		{
			SolidColorBrush background = GetSolidColorBrush((value as string) + "FF");
			return new SolidColorBrush(PerceivedBrightness(background) > 130 ? Microsoft.UI.Colors.Black : Microsoft.UI.Colors.White);
		}
