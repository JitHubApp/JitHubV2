...
namespace JitHub.WinUI.Views.Controls.Common
{
    ...
    {
        private IssueSideBarViewModel? _loadedViewModel;
        ...
        private static void OnViewModelChange(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            if (d is IssueSidePanel self && e.NewValue != null)
            {
                ...
                if (!ReferenceEquals(self._loadedViewModel, viewModel))
                {
        ...
        private void IssueSidePanel_Loaded(object sender, RoutedEventArgs e)
        {
