...
{
    internal sealed class ScriptLang
    {
    ...
    internal static class UnicodeLangBitsExtension
    {
    ...
    //unicode range 
    internal struct UnicodeRangeInfo
    {
    ...
    internal enum UnicodeLangBits : long
    {
        Unset = 0,
    ...
    internal static class ScriptLangs
    {
