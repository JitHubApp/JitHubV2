...
namespace Typography.OpenFont.MathGlyphs
{
    ...
    internal struct MathValueRecord
    {
        //MathValueRecord
    ...
    internal class MathGlyphConstruction
    {
    ...
    internal struct GlyphPartRecord
    {
    ...
    internal struct MathGlyphVariantRecord
    {
