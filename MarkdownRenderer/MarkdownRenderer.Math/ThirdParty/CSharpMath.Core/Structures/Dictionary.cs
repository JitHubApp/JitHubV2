...
namespace CSharpMath.Structures {
  ...
  internal class ProxyAdder<TKey, TValue> : IEnumerable {
  ...
  internal class LaTeXCommandDictionary<TValue> : ProxyAdder<string, TValue>, IEnumerable<KeyValuePair<string, TValue>> {
    internal delegate Result<(TValue Result, int SplitIndex)> DefaultDelegate(ReadOnlySpan<char> consume);
  ...
  internal class AliasBiDictionary<TFirst, TSecond> : ProxyAdder<TFirst, TSecond> where TFirst : notnull where TSecond : notnull {
