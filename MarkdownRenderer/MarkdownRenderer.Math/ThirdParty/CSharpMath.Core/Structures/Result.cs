...
namespace CSharpMath.Structures {
  ...
  internal readonly struct ResultImplicitError {
  ...
  internal readonly ref struct SpanResult<T> {
    ...
    internal delegate void Action(ReadOnlySpan<T> result);
    internal delegate void Action<TOther>(ReadOnlySpan<T> thisResult, TOther otherResult);
    internal delegate TResult Func<TResult>(ReadOnlySpan<T> result);
    internal delegate TResult Func<TOther, TResult>(ReadOnlySpan<T> thisResult, TOther otherResult);
