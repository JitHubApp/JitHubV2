...
#pragma warning disable CA1034 // Nested types should not be visible
    ...
    internal class TableEnvironment : IEnvironment {
    ...
    internal class InnerEnvironment : IEnvironment {
...
#pragma warning restore CA1034 // Nested types should not be visible
    ...
    private Result<MathList> BuildInternal(bool oneCharOnly, char stopChar = '\0', MathList? r = null) {
      using var recursion = MarkdownRenderer.Math.Internal.MathCancellationScope.EnterParserRecursion();
