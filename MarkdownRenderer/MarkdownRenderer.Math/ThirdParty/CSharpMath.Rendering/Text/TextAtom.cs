...
namespace CSharpMath.Rendering.Text {
  using Atom;
  //Base type
  internal abstract class TextAtom : System.IEquatable<TextAtom> {
    ...
    //Concrete types
    internal sealed class Text : TextAtom {
    ...
    internal sealed class ControlSpace : TextAtom {
      public override int? SingleChar(FontStyle style) => ' ';
      public override bool Equals(TextAtom atom) => atom is ControlSpace;
      public override int GetHashCode() => " ".GetHashCode();
    }
    internal sealed class Accent : TextAtom {
    ...
    internal sealed class Math : TextAtom {
    ...
    internal sealed class Style : TextAtom {
    ...
    internal sealed class Size : TextAtom {
    ...
    internal sealed class Colored : TextAtom {
    ...
    internal sealed class List : TextAtom {
    ...
    internal sealed class Comment : TextAtom {
